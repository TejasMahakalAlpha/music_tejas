...
import './ProductPerformanceBreakdown.css';

const ProductPerformanceBreakdown = () => {
  const facebookProducts = [
    ...
    { name: 'FBLITE CAMERA', value: '₹35,894' },
    { name: 'FB NOTES', value: '₹1,50,000' },
    { name: 'FB UGC LIVE', value: '₹35,894' },
    { name: 'FB MUSIC OVERLAY', value: '₹1,50,000' },
    { name: 'FB PROFILE', value: '₹35,894' },
    { name: 'FB LASSO BLUE', value: '₹1,50,000' },
    { name: 'FB UGC LIVE GAMING', value: '₹35,894' },
  ...
  const instagramProducts = [
    ...
    { name: 'IG MUSIC OVERLAY', value: '₹7,20,000' },
    { name: 'IG MUSIC ON PROFILE', value: '₹1,80,000' },
    { name: 'IG FROM FB CROSSPOST REELS', value: '₹70,000' },
    { name: 'IG UGC LIVE', value: '₹7,20,000' },
    { name: 'IG STORY CAMERA CLIPS', value: '₹1,70,000' },
    { name: 'IG QUESTION', value: '₹5,50,000' },
  ];
  ...
  const othersProducts = [
      ...
      { name: 'PROFILE SONG SEE ALL LIST', value: '₹50,000' },
       { name: 'PROFILE SONG PINNED SONG', value: '₹50,000' },
  ];
...
export default ProductPerformanceBreakdown;